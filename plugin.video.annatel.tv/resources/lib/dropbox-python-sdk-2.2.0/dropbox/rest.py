...
TRUSTED_CERT_FILE =  os.path.join(xbmc.translatePath(xbmcaddon.Addon(id='plugin.video.annatel.tv').getAddonInfo('path')), "resources", "lib", "dropbox-python-sdk-2.2.0", "dropbox" ,'trusted-certs.crt') #pkg_resources.resource_filename(__name__, 'trusted-certs.crt')
